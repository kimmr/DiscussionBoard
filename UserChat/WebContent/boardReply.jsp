			...
			<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						...
						<td><input class="form-control" type="text" maxlength="50" name="boardTitle" placeholder="Enter a title"></td>
					</tr>
					<tr>
						<td style="width: 110px;"><h5>Content</h5></td>
						<td><textarea class="form-control" rows="10" maxlength="2048" name="boardContent" placeholder="Enter content"></textarea></td>
					</tr>
					<tr>
						...
						<td colspan="2">
							...
							<div class="input-group col-xs-12">
								...
								<input type="text" class="form-control input-lg" disabled placeholder="Attachment">
					...
					<tr>
						<td style="text-align: left;" colspan="3"><h5 style="color: red;"></h5><input class="btn btn-primary pull-right" type="submit" value="upload"></td>
					</tr>
				</tbody>
			</table>
		</form>
