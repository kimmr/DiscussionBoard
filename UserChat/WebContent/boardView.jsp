...
<body>
	...
	<div class="container">
		<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
			<thead>
				<tr>
					<th colspan="5"><h4>Discussion Board</h4></th>
				</tr>
				<tr>
					<th style="bacnkground-color: #fafafa; color: #000000; width: 70px; text-align: center;"><h5>Number</h5></th>
					<th style="bacnkground-color: #fafafa; color: #000000; text-align: center;"><h5>Title</h5></th>
					<th style="bacnkground-color: #fafafa; color: #000000; text-align: center;"><h5>ID</h5></th>
					<th style="bacnkground-color: #fafafa; color: #000000; width: 100px; text-align: center;"><h5>Date</h5></th>
					<th style="bacnkground-color: #fafafa; color: #000000; width: 70px; text-align: center;"><h5>View</h5></th>
				</tr>
			</thead>
			<tbody>
			<%
			...
			%>
				...
				%>
				<tr>
					<td colspan="5"><a href="boardWrite.jsp" class="btn btn-primary pull-right" type="submit">Post</a></td>
				</tr>
			</tbody>
		</table>
	</div>
