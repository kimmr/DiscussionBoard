...
public class ChatDAO {
	...
	public ArrayList<ChatDTO> getChatListByRecent(String fromID, String toID, int number) {
		...
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		// SQL QUERY THAT ENABLES TO GET THE SENT MESSAGES BETWEEN THE USERS
	...
	public ArrayList<ChatDTO> getBox(String userID) {
		...
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		// SQL QUERY THAT GETS THE MOST RECENT MESSAGE
	...
	//To check if the receiver read the message
	...
	//Counts the amount of unread messages
